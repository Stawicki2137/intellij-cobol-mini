...
public class CobolMiniSecurityClauseImpl extends ASTWrapperPsiElement implements CobolMiniSecurityClause {

  public CobolMiniSecurityClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CobolMiniVisitor visitor) {
    visitor.visitSecurityClause(this);
  }
