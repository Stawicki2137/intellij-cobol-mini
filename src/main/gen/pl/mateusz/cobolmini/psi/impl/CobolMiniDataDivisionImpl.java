...
public class CobolMiniDataDivisionImpl extends ASTWrapperPsiElement implements CobolMiniDataDivision {

  public CobolMiniDataDivisionImpl(@NotNull ASTNode node) {
    super(node);
  }
