...
public class CobolMiniProcedureDivisionImpl extends ASTWrapperPsiElement implements CobolMiniProcedureDivision {

  public CobolMiniProcedureDivisionImpl(@NotNull ASTNode node) {
    super(node);
  }
