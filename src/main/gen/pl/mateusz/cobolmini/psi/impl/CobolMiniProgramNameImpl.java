...
public class CobolMiniProgramNameImpl extends ASTWrapperPsiElement implements CobolMiniProgramName {

  public CobolMiniProgramNameImpl(@NotNull ASTNode node) {
    super(node);
  }
