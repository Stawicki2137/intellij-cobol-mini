...
public class CobolMiniValueClauseImpl extends ASTWrapperPsiElement implements CobolMiniValueClause {

  public CobolMiniValueClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public CobolMiniLiteral getLiteral() {
    return findNotNullChildByClass(CobolMiniLiteral.class);
  }
