...
public class CobolMiniAuthorClauseImpl extends ASTWrapperPsiElement implements CobolMiniAuthorClause {

  public CobolMiniAuthorClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CobolMiniVisitor visitor) {
    visitor.visitAuthorClause(this);
  }
