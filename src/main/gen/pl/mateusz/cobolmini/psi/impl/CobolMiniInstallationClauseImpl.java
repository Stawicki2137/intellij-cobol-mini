...
public class CobolMiniInstallationClauseImpl extends ASTWrapperPsiElement implements CobolMiniInstallationClause {

  public CobolMiniInstallationClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CobolMiniVisitor visitor) {
    visitor.visitInstallationClause(this);
  }
