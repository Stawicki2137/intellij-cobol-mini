...
public class CobolMiniWorkingStorageSectionImpl extends ASTWrapperPsiElement implements CobolMiniWorkingStorageSection {

  public CobolMiniWorkingStorageSectionImpl(@NotNull ASTNode node) {
    super(node);
  }
