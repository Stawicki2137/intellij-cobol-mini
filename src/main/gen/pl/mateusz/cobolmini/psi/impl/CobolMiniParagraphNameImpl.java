...
public class CobolMiniParagraphNameImpl extends ASTWrapperPsiElement implements CobolMiniParagraphName {

  public CobolMiniParagraphNameImpl(@NotNull ASTNode node) {
    super(node);
  }
