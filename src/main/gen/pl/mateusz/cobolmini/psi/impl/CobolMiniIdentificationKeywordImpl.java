...
public class CobolMiniIdentificationKeywordImpl extends ASTWrapperPsiElement implements CobolMiniIdentificationKeyword {

  public CobolMiniIdentificationKeywordImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CobolMiniVisitor visitor) {
    visitor.visitIdentificationKeyword(this);
  }
