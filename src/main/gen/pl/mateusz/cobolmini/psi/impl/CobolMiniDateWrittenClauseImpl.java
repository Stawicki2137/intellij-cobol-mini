...
public class CobolMiniDateWrittenClauseImpl extends ASTWrapperPsiElement implements CobolMiniDateWrittenClause {

  public CobolMiniDateWrittenClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CobolMiniVisitor visitor) {
    visitor.visitDateWrittenClause(this);
  }
