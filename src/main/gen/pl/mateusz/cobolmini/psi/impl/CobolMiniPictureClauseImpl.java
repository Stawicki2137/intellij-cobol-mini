...
public class CobolMiniPictureClauseImpl extends ASTWrapperPsiElement implements CobolMiniPictureClause {

  public CobolMiniPictureClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
