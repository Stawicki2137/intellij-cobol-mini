...
public class CobolMiniCommentEntryImpl extends ASTWrapperPsiElement implements CobolMiniCommentEntry {

  public CobolMiniCommentEntryImpl(@NotNull ASTNode node) {
    super(node);
  }
